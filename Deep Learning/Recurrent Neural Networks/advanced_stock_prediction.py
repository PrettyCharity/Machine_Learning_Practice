...
class StockWithIndicators:
    """Class to fetch, process stock data, and compute technical indicators."""
    ...
    def get_data(self) -> pd.DataFrame:
        """Fetch stock data and calculate SMA and EMA."""
        df = yf.download(
            self.ticker,
    ...
    def visualize(self, y_pred: np.ndarray, stock_name: str = "") -> None:
        ...
        plt.title(f"{stock_name} Advanced Stock Price Prediction")
        plt.xlabel("Time")
...
def train_and_evaluate(
    ...
    data = StockWithIndicators(ticker, timesteps=60)
...
if __name__ == "__main__":
    # The feature experiment concluded that OHLCV + SMA_20 + EMA_20 yields the best results
    features_list = ["Open", "High", "Low", "Close", "Volume", "SMA_20", "EMA_20"]
